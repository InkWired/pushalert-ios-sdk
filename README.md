...
#### Change Log
Refer to the repository's [release tags](https://github.com/InkWired/pushalert-ios-sdk/releases) for a complete change log of every released version.

#### Support
Please visit this repository's [Github issue tracker](https://github.com/InkWired/pushalert-ios-sdk/issues) for feature requests and bug reports related specifically to the SDK.
